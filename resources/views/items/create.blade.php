                            ...
                            <div class="mb-6">
                                ...
                                <div class="relative">
                                    ...
                                    <input 
                                        ...
                                        name="name" 
                                        required
                                        class="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-200 transition duration-200"
                            ...
                            <div class="mb-8">
                                ...
                                <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-blue-400 transition duration-200">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <label 
                                            for="image" 
                                            class="cursor-pointer bg-white border-2 border-blue-500 text-blue-600 hover:bg-blue-50 font-semibold px-6 py-2 rounded-lg transition duration-200"
                                        >
                                            Choose File
                                        </label>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <ul class="text-sm text-blue-700 space-y-1">
                                    <li>• Use clear, descriptive names for better identification</li>
                                    <li>• High-quality images help showcase your products better</li>
                                    <li>• Double-check the price before saving</li>
                                </ul>
                            </div>
                        </div>
                    </div>
